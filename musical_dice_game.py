...
def construct_waltz():
    ...
    for minuet in minuet_table:
        song_list.append(minuet_filename(minuet[roll_dice(2)]))

    for trio in trio_table:
        song_list.append(trio_filename(trio[roll_dice(1)]))
